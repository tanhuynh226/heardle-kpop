var app = (function () {
  ...
  function dt(e) {
    ...
    return (
      ...
      })),
      {
        ...
        p(e, t) {
          const r = {};
          131072 & t[0] && (r.musicIsPlaying = e[17]), n.$set(r);
        },
        i(e) {
  ...
  function pt(e, t, n) {
    ...
    let M;
    function $() {
      (g = SC.Widget("soundcloud" + d.id)).bind(
  ...
  function Qt(e) {
    ...
    return (
      ...
      {
        c() {
          (t = w("div")), (n = w("p")), (r = _(L)), (s = x()), (i = w("div"));
